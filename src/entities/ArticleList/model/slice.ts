...
const articleListSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      .addCase(filterArticles.pending, (state: ArticleListSchema, action) => {
      ...
      .addCase(filterArticles.rejected, (state, action: PayloadAction<{ title: string, text: string } | undefined>) => {
        state.status = 'error'
