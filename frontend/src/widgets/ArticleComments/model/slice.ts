...
const articleCommentsSlice = createSlice({
	...
	extraReducers: (builder) => {
		builder
			.addMatcher(
				commentsApi.endpoints.getComments.matchPending,
				(state: ArticleCommentsSchema) => {
			...
			.addMatcher(
				articleAddingCommentApi.endpoints.addComent.matchFulfilled,
...
export const getArticleCommentsSelector =
